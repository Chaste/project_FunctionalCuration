...
public class GraphEvent
{
     ...
     */
    public GraphEvent(Event event, Graph source, int[] values)
    {
     ...
     */
    public GraphEvent(Event event, Graph source, int[] values, boolean hasOriginalEvent)
    {
        m_source = source;
        m_event = event;
        m_values = values;
