 ...
 *
 */
public class ComputationalModelVersion
{
	...
	public ComputationalModelVersion (ComputationalModel model, int id, String version, String author, String filePath, Timestamp created, int numFiles)
	{
		this.model = model;
		this.id = id;
	...
	public ComputationalModel getModel ()
	{
		return model;
	}
