...
function displayVersion (id)
{
	...
	for (var i = 0; i < v.files.length; i++)
	{
		...
		var a = document.createElement("a");
		a.href = contextPath + "/download/m/" + convertForURL (v.name) + "/" + v.id + "/" + file.id + "/" + convertForURL (file.name);
	...
	doc.model.details.style.display = "none";
	doc.model.version.style.display = "block";
...
function render ()
{
	...
	{
		doc.model.version.style.display = "none";
		doc.model.details.style.display = "block";
	}
}
...
function initModel ()
{
	doc = {
			model : {
				details : document.getElementById("modeldetails"),
				version : document.getElementById("modelversion")
			},
			version : {
				close : document.getElementById("modelversionclose"),
				name : document.getElementById("modelversionname"),
				time : document.getElementById("modelversiontime"),
				author : document.getElementById("modelversionauthor"),
				details : document.getElementById("modelversiondetails"),
				filestable : document.getElementById("modelversionfilestable"),
				filedetails : document.getElementById("modelversionfiledetails")
			},
			file: {
				close : document.getElementById("modelversionfileclose"),
				name : document.getElementById("modelversionfilename"),
				time : document.getElementById("modelversionfiletime"),
				author : document.getElementById("modelversionfileauthor")
			}
	};
    ...
    for (var i = 0; i < elems.length; i++)
    {
        ...
        if(classes.indexOf(' modelversionlink ') > -1)
        {
        ...
        if(classes.indexOf(' modelversionfilelink ') > -1)
        {
