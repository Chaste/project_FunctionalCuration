...
\item Workshop being planned for September 2015
  \begin{itemize}
  \item Focus on user training for the Web Lab
  \item Invite key members of cardiac modelling community, and potential collaborators
  \item Combine with training on the underlying functionality available in Chaste
  \end{itemize}
