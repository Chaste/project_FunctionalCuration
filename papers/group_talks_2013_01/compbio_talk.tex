...
\item Voltage clamp I-V curves
\item Running to steady state (including with alternans)
\item Finding refractory period
\item Graph state variables
\item Different restitution measures
\item Effect of hypokalaemia on APD
\end{itemize}
\end{frame}
