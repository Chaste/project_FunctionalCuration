...
ModifierCollection::ModifierCollection(const std::vector<boost::shared_ptr<AbstractSimulationModifier> >& rModifiers)
...
boost::shared_ptr<AbstractSimulationModifier>& ModifierCollection::operator[](unsigned i)
{
    return mModifiers[i];
}
