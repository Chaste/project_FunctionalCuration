#ifdef CHASTE_CVODE
#ifndef ASLANIDI_PURKINJE_MODEL_2009FROMCELLMLCVODELHOPITALED_HPP_
#define ASLANIDI_PURKINJE_MODEL_2009FROMCELLMLCVODELHOPITALED_HPP_
...
public:
    ...
    Aslanidi_Purkinje_model_2009FromCellMLCvodeLHopitaled(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus);
    ~Aslanidi_Purkinje_model_2009FromCellMLCvodeLHopitaled();
...
#endif // ASLANIDI_PURKINJE_MODEL_2009FROMCELLMLCVODELHOPITALED_HPP_
#endif // CHASTE_CVODE
