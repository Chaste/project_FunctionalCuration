...
class Aslanidi_Purkinje_model_2009FromCellMLCvodeNonLHopitaled : public AbstractCvodeCell, public AbstractDynamicallyLoadableEntity, public AbstractTemplatedSystemWithOutputs<N_Vector >
{
    //
