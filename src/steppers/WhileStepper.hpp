...
public:
    /**
     * Create a while stepper with the given stopping condition.
     *
     ...
     * @param pStoppingCondition  the stopping condition expression
     */
     ...
     * this is the environment in which the stopping condition will be evaluated.
     */
    void Initialise();
...
private:
    ...
    AbstractExpressionPtr mpStoppingCondition;
};
